...
Route::get('/cultures.geojson', [WelcomeController::class, 'culturesGeoJson'])->name('cultures.geojson');
Route::get('/search', [WelcomeController::class, 'searchPlaces'])->name('search');
