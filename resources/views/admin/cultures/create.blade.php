                ...
                <div class="bg-white p-1 rounded-[2.5rem] border border-gray-200 shadow-sm">
                    <div class="p-6 md:p-8 rounded-[2rem] border border-gray-100 bg-white space-y-8">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <textarea id="description" name="description" x-ref="description_id" rows="3" class="block w-full border-gray-300 rounded-xl focus:border-blue-500 focus:ring-blue-500 shadow-sm" placeholder="Berikan ringkasan budaya ini...">{{ old('description') }}</textarea>
                                                <x-input-error class="mt-2" :messages="$errors->get('description')" />
                                            </div>
                                            <div>
                                                <label for="description_en" class="block text-sm font-semibold text-gray-700 mb-1">Deskripsi Singkat (EN)</label>
                                                <textarea id="description_en" name="description_en" x-ref="description_en" rows="3" class="block w-full border-gray-300 rounded-xl focus:border-blue-500 focus:ring-blue-500 shadow-sm bg-indigo-50/30" placeholder="Short description in English...">{{ old('description_en') }}</textarea>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <textarea id="content" name="content" x-ref="content_id" rows="6" class="block w-full border-gray-300 rounded-xl focus:border-blue-500 focus:ring-blue-500 shadow-sm" placeholder="Tuliskan penjelasan detail di sini...">{{ old('content') }}</textarea>
                                                <x-input-error class="mt-2" :messages="$errors->get('content')" />
                                            </div>
                                            <div>
                                                <label for="content_en" class="block text-sm font-semibold text-gray-700 mb-1">Konten Lengkap (EN)</label>
                                                <textarea id="content_en" name="content_en" x-ref="content_en" rows="6" class="block w-full border-gray-300 rounded-xl focus:border-blue-500 focus:ring-blue-500 shadow-sm bg-indigo-50/30" placeholder="Full details in English...">{{ old('content_en') }}</textarea>
                        ...
                        <div x-show="['Kuliner Khas', 'Kemahiran & Kerajinan Tradisional (Kriya)'].includes(selectedCategory)" x-transition x-cloak
                             ...
                             x-init="if(locations.length === 0) locations.push({name: '', category_id: '', address: '', google_maps_url: '', open_time: '', close_time: ''})">
                            <hr class="border-gray-100 my-8">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-bold text-gray-900 flex items-center gap-2">
                                    <i class="fa-solid fa-map-location-dot text-red-500"></i> Titik Lokasi Rekomendasi
                                </h3>
                                <button type="button" @click="locations.push({name: '', category_id: '', address: '', google_maps_url: '', open_time: '', close_time: ''})" 
