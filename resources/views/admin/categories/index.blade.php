                                ...
                                @forelse ($categories as $category)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="w-8 h-8 rounded-full flex items-center justify-center text-white" style="background-color: {{ $category->color }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center gap-2">
                                                <div class="w-4 h-4 rounded shadow-sm border border-gray-200" style="background-color: {{ $category->color }}"></div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <form action="{{ route('admin.categories.destroy', $category) }}" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kategori ini? Semua lokasi terkait juga akan terhapus!');">
                                                @csrf
                                                @method('DELETE')
