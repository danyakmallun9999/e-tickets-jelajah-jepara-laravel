                    ...
                    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="price" class="block mt-1 w-full" type="number" name="price" :value="old('price')" required min="0" step="100" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="seller_name" class="block mt-1 w-full" type="text" name="seller_name" :value="old('seller_name')" placeholder="Contoh: Kerajinan Ukir Pak Joyo" />
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="seller_contact" class="block mt-1 w-full" type="text" name="seller_contact" :value="old('seller_contact')" placeholder="Contoh: 081234567890" />
