    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <h2 class="font-bold text-2xl text-gray-900 leading-tight">Tambah Pengumuman</h2>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('admin.announcements.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6"
                 x-data="{
                    preview: null,
                    format: '{{ old('image_format', 'landscape') }}',
                    btnText: '{{ old('button_text') }}',
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea name="content" rows="4"
                                              ...
                                              class="block w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:bg-white focus:ring-0 focus:border-blue-500 transition-all"
                                              placeholder="Isi pengumuman...">{{ old('content') }}</textarea>
                        ...
                        <div class="rounded-xl border border-blue-200 bg-blue-50/50 p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <textarea id="content_en" name="content_en" rows="4"
                                          ...
                                          x-ref="content_en">{{ old('content_en') }}</textarea>
