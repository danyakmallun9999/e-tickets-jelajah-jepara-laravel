                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-blue-50/50 border border-blue-100 overflow-hidden shadow-sm sm:rounded-lg p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="title_en" class="block mt-1 w-full" type="text" name="title_en" :value="old('title_en', $post->title_en)" placeholder="Automatic or manual english title..." />
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-1">
                                    <textarea id="content_en" name="content_en" class="block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 settings-tiny">{{ old('content_en', $post->content_en) }}</textarea>
                                </div>
                        ...
                        <script>
                            ...
                            if(translateBtn) {
                                translateBtn.addEventListener('click', async function() {
                                    ...
                                    const contentId = tinymce.get('content').getContent({format: 'text'}); 
