<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.boundaries.create') }}" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow-sm sm:rounded-2xl p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-900">Daftar Batas Wilayah</h3>
                    <p class="text-sm text-gray-500">Total: {{ $boundaries->total() }} batas</p>
                </div>
                            ...
                            @forelse($boundaries as $boundary)
                                <tr>
                                    <td class="px-4 py-4">
                                        ...
                                        <p class="text-xs text-gray-500 line-clamp-1">{{ $boundary->description }}</p>
                                    </td>
                                    <td class="px-4 py-4">
                                    ...
                                    <td class="px-4 py-4 text-sm text-gray-600">
                                        {{ $boundary->area_hectares ? number_format($boundary->area_hectares, 2) : '-' }}
                                    </td>
                                    <td class="px-4 py-4">
