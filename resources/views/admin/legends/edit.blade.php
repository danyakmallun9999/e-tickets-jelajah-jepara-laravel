<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('admin.legends.update', $legend) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="space-y-6">
                    {{-- Basic Info --}}
                    <div class="bg-white p-6 rounded-[2.5rem] border border-gray-200 shadow-sm">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-2">
                                ...
                                <input id="name" name="name" type="text" value="{{ old('name', $legend->name) }}" required
                            ...
                            <div>
                                ...
                                <input id="order" name="order" type="number" value="{{ old('order', $legend->order) }}"
                                       class="block w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:bg-white focus:ring-0 focus:border-blue-500 transition-all" />
                    ...
                    <div class="bg-white p-6 rounded-[2.5rem] border border-gray-200 shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input id="quote_id" name="quote_id" type="text" value="{{ old('quote_id', $legend->quote_id) }}"
                                       class="block w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:bg-white focus:ring-0 focus:border-blue-500 transition-all" />
                            ...
                            <div>
                                ...
                                <input id="quote_en" name="quote_en" type="text" value="{{ old('quote_en', $legend->quote_en) }}"
                                       class="block w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:bg-white focus:ring-0 focus:border-blue-500 transition-all" />
                    ...
                    <div class="bg-white p-6 rounded-[2.5rem] border border-gray-200 shadow-sm">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <textarea name="description_id" id="description_id" rows="3" class="mt-1 block w-full bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:bg-white focus:ring-0 focus:border-blue-500 transition-all shadow-sm">{{ old('description_id', $legend->description_id) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="description_en" id="description_en" rows="3" class="mt-1 block w-full bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:bg-white focus:ring-0 focus:border-blue-500 transition-all shadow-sm">{{ old('description_en', $legend->description_en) }}</textarea>
                    ...
                    <div class="flex items-center justify-end gap-3">
                        <label class="inline-flex items-center mr-4 cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" {{ $legend->is_active ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500">
                            <span class="ml-2 text-sm text-gray-600 font-medium">Aktif</span>
                        </label>
