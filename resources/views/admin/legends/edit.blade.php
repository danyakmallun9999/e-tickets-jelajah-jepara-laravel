                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <textarea name="description_id" id="description_id" rows="3" 
                                          ...
                                          class="mt-1 block w-full bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:bg-white focus:ring-0 focus:border-blue-500 transition-all shadow-sm">{{ old('description_id', $legend->description_id) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="description_en" id="description_en" rows="3" 
                                          ...
                                          class="mt-1 block w-full bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:bg-white focus:ring-0 focus:border-blue-500 transition-all shadow-sm">{{ old('description_en', $legend->description_en) }}</textarea>
