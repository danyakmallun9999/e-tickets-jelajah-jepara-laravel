...
<body class="font-sans antialiased bg-gray-50 text-slate-800 flex flex-col min-h-screen">
    ...
    <!-- Top Navigation -->
    <div
        class="sticky top-0 z-[10000] w-full border-b border-white/10 bg-white/50 dark:bg-black/50 backdrop-blur-md">
            ...
            <header class="flex h-20 items-center justify-between gap-8" x-data="{ mobileMenuOpen: false }">
                ...
                <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200"
                    ...
                    <nav class="flex flex-col gap-4">
                        ...
                        <a class="text-sm font-medium hover:text-primary transition-colors p-2" href="{{ route('welcome') }}#gis-map">Peta
                            GIS</a>
                        <a class="text-sm font-medium hover:text-primary transition-colors p-2"
