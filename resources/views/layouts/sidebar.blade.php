    ...
    <div :class="{'translate-x-0': open, '-translate-x-full': !open}" 
        ...
        <div class="flex items-center h-20 border-b border-gray-200 px-4 transition-all duration-300" :class="sidebarMinimized ? 'justify-center' : 'justify-between'">
            <a href="{{ route('dashboard') }}" class="flex items-center gap-2 group">
                <img x-show="sidebarMinimized" src="{{ asset('images/logo-kura.png') }}" class="w-10 h-10 object-contain transition flex-shrink-0" alt="Logo">
                <span x-show="!sidebarMinimized" class="font-bold text-xl text-gray-800 tracking-tight whitespace-nowrap transition-opacity duration-300">Jelajah<span class="text-blue-600">Jepara</span></span>
            </a>
