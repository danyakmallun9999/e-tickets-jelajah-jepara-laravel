                            ...
                            <div id="locations-scroll-container" class="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-700 p-6 space-y-4 relative z-0 scroll-smooth">
                                ...
                                <template x-for="(loc, index) in locations" :key="loc.id || index">
                                    <div :id="'card-' + index"
                                        ...
                                        <template x-if="(loc.latitude && loc.longitude) || loc.google_maps_url">
                                            <div class="mt-2 text-right">
                                                <a @click.stop :href="(loc.latitude && loc.longitude) ? ('https://www.google.com/maps/dir/?api=1&destination=' + loc.latitude + ',' + loc.longitude + (userLocation ? '&origin=' + userLocation.lat + ',' + userLocation.lng : '')) : loc.google_maps_url" target="_blank" 
                    ...
                    return {
                        ...
                        buildMarkers() {
                            ...
                            this.locations.forEach((loc, index) => {
                                ...
                                const originParam = this.userLocation ? `&origin=${this.userLocation.lat},${this.userLocation.lng}` : '';
                                const mapsLink = (lat && lng) ? `https://www.google.com/maps/dir/?api=1&destination=${lat},${lng}${originParam}` : (loc.google_maps_url || '#');
